...
class EmailController extends CI_Controller
{
    ...
    public function send_mail($html = '', $subject, $to_email = 'support@ed-ayurveda.com')
    {
        $config = array();
        $config['protocol'] = 'smtp';
        // $config['smtp_crypto'] = 'ssl';
        $config['smtp_host'] = 'ed-ayurveda.com';
        $config['smtp_user'] = 'support@ed-ayurveda.com';
        $config['smtp_pass'] = 'Sservice@1234';
        ...
        $from_email = "support@ed-ayurveda.com";
        // $to_email = "support@ed-ayurveda.com";
        // $to_email = "fepila8008@abincol.com";

        $this->email->from($from_email, 'ED Ayurveda');
    ...
    function load()
    {
        $this->load->view('email-templates/news-letter-temp');
    }
}
